            ...
            <div className=" container">
                <div className="row">
                    <div className={Styles.title_section}>
                        <h2 className={Styles.title_section_size}>Wedcell In House Services</h2>
                        <p className={Styles.title_description}>
                        You can browse all in house services by category with thumbnail image and category name.
                        </p>
                        <p className='text-gray text-center' >
                        For More details : Mob No- +91 98111 86660, Email Id- info@wedcell.com
                        </p>
                    </div>
                </div>
                <div className="row">
